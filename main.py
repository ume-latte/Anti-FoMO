...
# 生成 Spotify 授權 URL
def generate_spotify_auth_url(client_id, redirect_uri, scope):
    auth_url = f"{SPOTIFY_AUTH_URL}?client_id={client_id}&response_type=code&redirect_uri={quote(redirect_uri)}&scope={quote(scope)}"
    return auth_url
